...
function Ausgabe() {
	alert("Die Daten rechts müssen nun geladen sein!");
}

function Klicke() {
	var obj = document.getElementById("data.group.name");
	obj.addEventListener('click', Ausgabe, true);
}
var obj = document.getElementById("data.group.name");
obj.addEventListener('click', Klicke);
